...
Before you start the process of making a domain.sabbir.cc domain, make sure you have the following:
...
3. Make sure the website isn't for commercial purposes; if the website is for commercial purposes, we have the right to close the pull request. You can read our Terms of Conditions [here](https://domain.sabbir.cc/terms).

After you've made sure that you meet these requirements, we can continue with the process of making a domain.sabbir.cc domain.

## Making the domain.sabbir.cc domain
