...
# Setting up Render with an code-space.me Subdomain

This guide will walk you through the process of setting up a Render deployment and pointing your code-space.me subdomain towards it.
...
- Navigate to **Settings > Custom Domains** and add `subdomain.code-space.me` in the given field.
...
- Your Render service should now be accessible at `subdomain.code-space.me`.
