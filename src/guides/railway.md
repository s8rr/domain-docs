...
# Setting up code-space.me with Railway
...
6. Enter the `code-space.me` subdomain you want to use.
...
- **If the PR has been merged but the DNS records haven't updated and you have waited 48 hours,**
