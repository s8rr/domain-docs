...
# Setting up Netlify with an code-space.me Subdomain

This guide will walk you through the process of setting up a Netlify deployment and pointing your code-space.me subdomain towards it.
...
To get the records for Netlify, navigate to **Site Settings > Domain Management > Custom Domains** and add `subdomain.code-space.me` (as an example, you should add the domain which you want to register) in the given field.

### Creating the Domain File

You should see two domains that Netlify added, `subdomain.code-space.me` and `www.subdomain.code-space.me`. You have to make both of them so that you can successfully add a domain to Netlify. (`subdomain` being your domain name of choice, of course)
...
- Your Netlify website should now be accessible at `your-subdomain.code-space.me`.
