...
# Setting up Discord domain connection with your code-space.me subdomain
...
5. In the field that appears type your code-space.me domain name (e.g. `your-domain.code-space.me`).
