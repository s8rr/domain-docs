...
When you create your Hashnode blog, Hashnode provides a free `hashnode.dev` subdomain for you. However, you can alternatively set up your own `code-space.me` subdomain.
...
Once the DNS has propagated, you can start enjoying your Hashnode blog with your sweet `.code-space.me` subdomain!
...
Please note that code-space.me is not affiliated with Hashnode. If you're experiencing issues with your Hashnode blog, please seek help through Hashnode's support channels. We are unable to assist with Hashnode-specific issues.
