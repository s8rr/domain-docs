...
# Setting up ImprovMX with an code-space.me subdomain

This guide will walk you through the process of setting up ImprovMX with your code-space.me subdomain.
...
2. You should have already forked the [code-space.me repository](https://github.com/is-a-dev/register). If you haven't forked the repository, please make one by using [this link](https://github.com/is-a-dev/register/fork).
...
**After you've made the file, make a pull request to the [code-space.me repository](https://github.com/s8rr/domain).**
