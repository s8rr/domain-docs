# Setting up a Bluesky custom handle with an code-space.me subdomain
...
5. **Enter** your code-space.me subdomain name in the text input and then **Copy** the TXT string. (e.g. `your-subdomain.code-space.me`).
