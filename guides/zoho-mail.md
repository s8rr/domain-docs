# Setting up Zoho Mail using code-space.me subdomain

This guide will walk you through the process of setting up custom email in Zoho Mail with your code-space.me subdomain.
...
2. You must have an code-space.me subdomain to set up and use Zoho Mail services. Learn more in our [GitHub repository](https://github.com/is-a-dev/register).
...
2. Enter `your-domain.code-space.me` subdomain and the name of your organization in the pop-up. The organization name can be your personal name too. Click **Add now** to proceed.
...
6. Now that you have verified ownership of your domain, click **Create** to create your first email using your code-space.me subdomain.

   ![](../media/zohomail/step_6.png)

## DNS Mapping

After you verified your domain, you may see the **Setup Users** and **Setup Groups** sections, where you can set up your users (such as example@your-domain.code-space.me) and groups. For now, you can skip these and move on to **DNS Mapping**.
...
2. Now only **DKIM record** is left, for this you have to create a **new file** named `zmail._domainkey.your-domain.json`. Please note that `your-domain` should be replaced with the code-space.me subdomain that you own.
...
After all your pull requests has been merged, you will see the same page as above, if you see it, you are all set and your email is now ready to use with the code-space.me subdomain. Enjoy your custom email!
