# Setting up Firebase Hosting with an code-space.me Subdomain

This guide will walk you through the process of setting up a Firebase Hosting site and pointing your code-space.me subdomain towards it.
...
After your pull request is merged and your code-space.me subdomain is active:

1. Go to your Firebase Console
2. Navigate to **Hosting** in the left sidebar
3. Click **Add custom domain**
4. Enter your code-space.me subdomain (e.g., `example.code-space.me`)
